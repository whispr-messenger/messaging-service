...
config :whispr_messaging, WhisprMessaging.Repo,
  username: System.get_env("DB_USERNAME") || "tudygbaguidi",
...
config :whispr_messaging, WhisprMessagingWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "2uzCO6qcs3lGyNwBkAiCqfPpd8HVXsr4QGoO143FgUcA55hIZLNJYvzFCyRy3Rtl",
  watchers: []
...
# Configuration Redis pour le développement (désactivé si Redis n'est pas installé)
