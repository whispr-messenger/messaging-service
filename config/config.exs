...
config :whispr_messaging, WhisprMessagingWeb.Endpoint,
  ...
  live_view: [signing_salt: "rCO6XOGf"]
...
config :whispr_messaging, WhisprMessaging.Mailer, adapter: Swoosh.Adapters.Local
...
# Configuration gRPC
import_config "grpc.exs"

# Configuration Redis
import_config "redis.exs"
