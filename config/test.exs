...
config :whispr_messaging, WhisprMessagingWeb.Endpoint,
  ...
  secret_key_base: "HjTBXjyN0ZdsxX4PNjcxcaQfeGq6PFK7fb7Z2gGziBAA3iyScSkqOt6dXvzlMIN4",
  server: false

# In test we don't send emails
config :whispr_messaging, WhisprMessaging.Mailer, adapter: Swoosh.Adapters.Test
